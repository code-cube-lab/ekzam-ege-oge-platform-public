...
const questions = [
  ...
  { label: "Лексика", question: "В каком предложении слово употреблено точно?", options: ["Он надел пальто и вышел.", "Он одел пальто и вышел.", "Он оплатил за проезд.", "Он занял другу деньги."] },
  { label: "Грамматика", question: "Выберите правильное продолжение: «Читая статью, ...»", options: ["у меня возник вопрос", "обратите внимание на аргументы", "мне запомнился пример", "текст показался сложным"] },
  { label: "Синтаксис", question: "Сколько грамматических основ: «Когда стемнело, мы вернулись, и дождь закончился»?", options: ["1", "2", "3", "4"] },
  { label: "Выразительность", question: "Какое средство использовано: «Лес проснулся и зашептал»?", options: ["Гипербола", "Олицетворение", "Литота", "Антитеза"] },
  { label: "Смысл текста", question: "Какой тезис можно доказать примером о человеке, который выполнил обещание несмотря на трудности?", options: ["Погода влияет на настроение.", "Верность слову требует ответственности.", "Путешествовать всегда легко.", "Любая ошибка приносит успех."] },
];
    ...
    return (
      <div className="app-shell">
        ...
        <main className="app-main">
          <div className="app-top"><div><h1>Диагностика русского языка</h1><p>10 вопросов одного предмета · около 8 минут</p></div><button className="button button-ghost button-small" onClick={() => setQuizOpen(false)}>Закрыть</button></div>
