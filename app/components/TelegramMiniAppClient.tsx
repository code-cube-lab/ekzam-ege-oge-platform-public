...
export function TelegramMiniAppClient() {
  ...
  if (status === "preview") return <main className="telegram-app"><div className="telegram-preview"><span className="telegram-logo">Э</span><h1>«ЭКЗАМ» открывается в Telegram</h1><p>Внутри бота ученик проходит полный вариант, получает ежедневное задание и оплачивает практику Telegram Stars.</p><a className="button button-primary" href="/exam">Пройти полный вариант</a><small>Оплата доступна только из реального Telegram Mini App после проверки сессии.</small></div></main>;
