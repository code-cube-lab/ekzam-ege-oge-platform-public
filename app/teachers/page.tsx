...
export default function TeachersPage() {
  return <main className="faculty-page">
    ...
    <section className="faculty-hero exam-faculty-hero">
      ...
      <p>Для каждого основного направления выбран предметный профиль по официальным материалам Ставропольского президентского кадетского училища. Официальные фотографии отмечены ссылкой на источник, а AI-визуалы направлений — отдельной подписью.</p>
