...
export const taskBank: DailyTask[] = [
  {
    ...
    options: ["звОнит", "звонИт", "звонит (без отметки)", "звонИтся"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["непрочитанная мною книга", "не прочитанная мною книга", "не-прочитанная мною книга", "непрочитанная-мною книга"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["Уставший после дороги он уснул.", "Уставший после дороги, он уснул.", "Уставший, после дороги он уснул.", "Уставший после дороги он, уснул."],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["по вечерам", "становилось прохладно", "вечерам становилось", "прохладно по вечерам"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["олицетворение", "литота", "градация", "анафора"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["антитеза", "градация", "инверсия", "анафора"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["Вот такой пример.", "Этот эпизод показывает, что выбор героя основан на чувстве долга.", "Автор рассказывает историю.", "В произведении много героев."],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["деление на строфы", "основа в диалогах и ремарках", "обязательный рассказчик", "только стихотворная форма"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["эпитет", "анафора", "оксюморон", "градация"],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ["Герой добрый, потому что он хороший.", "Герой проявляет сострадание: он отказывается от выгоды, чтобы помочь другому.", "Мне понравился этот герой.", "Автор называет героя по имени."],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["с пересказа обоих текстов", "с общего критерия и тезиса о сходстве или различии", "с перечисления фамилий авторов", "с оценки объёма произведений"],
    correctIndex: 1,
